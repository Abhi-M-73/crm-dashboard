...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Registration API call logic yahan aayega
    navigate("/login");
  };
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-[#F4EFEA] p-4 sm:p-6 lg:p-10 font-sans antialiased text-stone-800">
      ...
      <div className="relative flex w-full max-w-[1180px] overflow-hidden rounded-[40px] bg-white shadow-[0_20px_60px_rgba(0,0,0,0.07)] border border-stone-200/80 min-h-[640px] p-3">
        ...
        >
          ...
          {/* <div className="relative z-10 my-auto py-8 max-w-xs space-y-2">
        ...
        <div className="relative flex flex-1 flex-col justify-between p-6 sm:p-10 lg:p-10 lg:-ml-12 z-20">
          ...
          <div className="mx-auto w-full max-w-[360px] py-4">
            <div className="mb-5 text-center">
              ...
              <p className="mt-1 text-sm font-medium text-stone-400">
                Register your credentials to get started
              </p>
            </div>
          ...
          {/* Social Icons Footer */}
          <div className="flex items-center justify-center gap-4 text-stone-400 pt-1">
